...
export default function Index() {
  ...
  return (
    <>
          ...
          >
            <div className='w-full'>
              <div className='flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-3 mx-4'>
                ...
                <button
                  ...
                  className='text-gray-800 dark:text-blue-500 focus:outline-none focus:ring-2 focus:ring-gray-800'
                >
                  <svg
            ...
            <div className='mt-4 mx-4'>
              <ul className='flex flex-col space-y-4'>
                <li className='border-b border-gray-200 dark:border-gray-700 dark:text-gray-700 pb-4 px-1 flex items-center justify-between'>
                  ...
                  <button
                    aria-label='Add'
                    className='dark:text-blue-500 text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 rounded hover:bg-gray-100 dark:hover:bg-gray-700'
                  >
                    <svg
                      className='fill-stroke'
                      width={16}
            ...
            <div className='w-full h-full flex items-end'>
              <ul className='bg-gray-50 dark:bg-gray-800 py-10 px-4 flex flex-col space-y-8 w-full'>
                <li>
                  <a
                    className='flex items-center space-x-2 focus:outline-none text-gray-800 dark:text-blue-500 focus:ring-2 focus:ring-gray-800 hover:underline'
                    href='javascript:void(0)'
                  >
                    <div>
                      <svg
                ...
                <li>
                  <a
                    className='flex items-center space-x-2 text-gray-800 dark:text-blue-500 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline'
                    href='javascript:void(0)'
                  >
                    <div>
                      <svg
      ...
      <Cart show={bagOpen} setShow={setbagOpen} />
    </>
  );
}
